...
class Point < GeometryValue
  ...
  def intersectPoint p
    # intersection of point with another point is the same point
    # if both are same (or real close) and NoPoints otherwise
  ...
  def intersectLine line
    # if current point lies on the line, then return the point
    # otherwise a NoPoints instance
    if real_close(@y, line.m * @y + line.b)
    then self
    else NoPoints.new
    end
  end
...
class Var < GeometryExpression
  ...
  def preprocess_prog # no pre-processing to do for a variable
    self
  end
